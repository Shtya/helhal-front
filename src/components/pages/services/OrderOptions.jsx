      ...
      ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className='px-6 pb-36 pt-2 space-y-6 overflow-y-auto h-[calc(100dvh-140px)]'>
          ...
          <div>
            ...
            <textarea rows={4} value={notes} onChange={e => setNotes(e.target.value)} placeholder='Anything the seller should know…' className='w-full rounded-xl border border-slate-300 px-3 py-2 text-sm text-slate-800 outline-none transition focus:border-main-500 focus:ring-2 focus:ring-main-100' />
