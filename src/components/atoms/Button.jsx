...
export default function Button({ name, disabled, icon, srcImg, onClick, href, className = '', color = 'green', type = "button", loading = false }) {
  const colorClasses = {
    ...
    // outline: 'border-[2px] border-main-500 !text-main-500 hover:bg-main-500 hover:!text-white',  
    ...
    green: 'bg-main-600 text-white hover:bg-main-700 focus-visible:ring-main-400/50',
    success: 'bg-main-600 text-white hover:bg-main-700 focus-visible:ring-main-400/50',
