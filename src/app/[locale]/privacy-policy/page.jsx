        ...
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            {loadingSettings ? (
                ...
                <RichTextRenderer
                    ...
                    className="text-lg leading-loose text-dark dark:text-dark-text-primary"
                ...
                <div className="flex flex-col items-center justify-center mt-8 p-6 border border-dashed border-slate-300 rounded-lg bg-slate-50 dark:bg-dark-bg-card">
                    ...
                    <p className="text-lg font-semibold text-slate-700 dark:text-dark-text-primary">
                        {t("notFoundTitle")}
                    </p>
                    <p className="text-sm text-slate-500 dark:text-dark-text-secondary mt-1 text-center max-w-md">
