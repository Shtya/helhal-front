...
export default function Page() {
  ...
  const columns = [
    ...
    },
    {
      ...
      status: [
        ["Active", 'text-main-500 bg-main-100 dark:text-main-400 dark:bg-main-900 px-2 py-1 rounded'],
        ['Pending', 'text-yellow-500 bg-yellow-100 dark:text-yellow-400 dark:bg-yellow-900 px-2 py-1 rounded'],
        ["Draft", 'text-gray-500 bg-gray-100 dark:text-gray-400 dark:bg-gray-900 px-2 py-1 rounded'],
        ["Denied", 'text-red-500 bg-red-100 dark:text-red-400 dark:bg-red-900 px-2 py-1 rounded'],
        ["Paused", 'text-blue-500 bg-blue-100 dark:text-blue-400 dark:bg-blue-900 px-2 py-1 rounded'],
      ],
    },
    {
      key: 'created_at',
  ...
  const renderActions = (row) => {
    const baseStyle =
      'w-8 h-8 flex items-center justify-center rounded-md border transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-main-500/50';
    ...
    return (
      <div className="flex space-x-2 mx-auto w-fit">
        <Link
          ...
          className={`${baseStyle} border-blue-200 bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-800 dark:border-blue-800 dark:bg-blue-900 dark:text-blue-400 dark:hover:bg-blue-800 dark:hover:text-blue-200`}
        >
        ...
        {/* <Link
        href={`/create-gig?slug=${service.slug}`}
        className={`${baseStyle} border-main-200 bg-main-50 text-main-600 hover:bg-main-100 hover:text-main-800 dark:border-main-800 dark:bg-main-900 dark:text-main-400 dark:hover:bg-main-800 dark:hover:text-main-200`}
      >
        <Pencil className="w-4 h-4" />
      </Link> */}

        <button
          className={`${baseStyle} border-red-200 bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-800 dark:border-red-800 dark:bg-red-900 dark:text-red-400 dark:hover:bg-red-800 dark:hover:text-red-200`}
  ...
  return (
    <div className="container min-h-screen !py-12">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-gray-50 dark:bg-dark-bg-card border border-slate-200 dark:border-dark-border rounded-lg p-4 !mb-4 mt-2 transition-colors duration-300">
        ...
        <Modal title={t('delete.title')} onClose={() => setDeleteTarget(null)}>
          ...
          <div className="flex justify-end gap-3">
            <Button
              ...
              className="!w-fit"
              name={t('delete.cancel')}
            />
            <Button
              onClick={confirmDelete}
              disabled={deleting}
              name={deleting ? t('delete.deleting') : t('delete.delete')}
              color="red"
              className="!w-fit"
            />
          </div>
